...
public class DiningPhilosophers3 {
    public static void main(String[] args) throws IOException {
        ...
        InetSocketAddress rightNeighborAdress = new InetSocketAddress("localhost", 5001);
...
//        ServerSocket serverSocket = new ServerSocket(Integer.parseInt(args[1])); // Use a fixed port for listening
        //ServerSocket serverSocket = new ServerSocket(5003); // Use a fixed port for listening
